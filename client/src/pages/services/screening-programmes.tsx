        ...
        <section ref={heroRef} className="section-padding bg-compleo-deep-teal text-white">
          <div className="max-w-7xl mx-auto container-padding text-center">
            ...
            <div className="flex flex-row gap-3 sm:gap-6 justify-center">
              <Link href={heroContent.button1.href} onClick={() => trackCTAClick(heroContent.button1.analytics, '/services/screening-programmes')}>
                <Button 
                  size="lg" 
              ...
              <Link href={heroContent.button2.href} onClick={() => trackCTAClick(heroContent.button2.analytics, '/services/screening-programmes')}>
                <Button 
                  size="lg" 
