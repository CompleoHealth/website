            ...
            <div className="flex flex-row gap-3 sm:gap-6 justify-center">
              <Link href={heroContent.button1.href} tabIndex={-1}>
                <Button
                  ...
                  onClick={() => {
                    trackCTAClick(heroContent.button1.analytics, '/services/community-diagnostic-centres');
              ...
              <Link href={heroContent.button2.href} tabIndex={-1}>
                <Button
                  ...
                  onClick={() => {
                    trackCTAClick(heroContent.button2.analytics, '/services/community-diagnostic-centres');
